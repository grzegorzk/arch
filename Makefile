...
IMG_NAME=docker.io/techgk/arch:bootstrap_${BOOTSTRAP_YEAR}${BOOTSTRAP_MONTH}${BOOTSTRAP_DAY}-archives_${PACMAN_ARCHIVES_YEAR}${PACMAN_ARCHIVES_MONTH}${PACMAN_ARCHIVES_DAY}
