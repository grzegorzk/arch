...
IMG_NAME=docker.io/techgk/arch:bootstrap_${ARCH_BOOTSTRAP_DAY}${BOOTSTRAP_MONTH}${BOOTSTRAP_DAY}-archives_${PACMAN_ARCHIVES_YEAR}${PACMAN_ARCHIVES_MONTH}${PACMAN_ARCHIVES_DAY}
